...
test: manifests generate fmt vet envtest ## Run tests.
	GOTOOLCHAIN=go1.26.0+auto KUBEBUILDER_ASSETS="$(shell $(ENVTEST) use $(ENVTEST_K8S_VERSION) --bin-dir $(LOCALBIN) -p path)" go test ./... -coverprofile cover.out
