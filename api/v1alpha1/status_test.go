...
func Test_IsEventingAuthStatusEqual(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			givenOldStatus: createEventingAuthStatus(metav1.ConditionTrue, metav1.ConditionTrue, "mock-app1", "mock-secret-ns1", StateReady),
			givenNewStatus: createEventingAuthStatus(metav1.ConditionTrue, metav1.ConditionTrue, "mock-app1", "mock-secret-ns1", StateReady),
			result:         true,
		},
		{
			name:           "Should not be equal as conditions are different",
			givenOldStatus: createEventingAuthStatus(metav1.ConditionTrue, metav1.ConditionFalse, "mock-app1", "mock-secret-ns1", StateReady),
			givenNewStatus: createEventingAuthStatus(metav1.ConditionTrue, metav1.ConditionTrue, "mock-app1", "mock-secret-ns1", StateReady),
			result:         false,
		},
		{
			...
			givenOldStatus: createEventingAuthStatus(metav1.ConditionTrue, metav1.ConditionTrue, "mock-app1", "mock-secret-ns1", StateReady),
			givenNewStatus: createEventingAuthStatus(metav1.ConditionTrue, metav1.ConditionTrue, "mock-app2", "mock-secret-ns2", StateReady),
			result:         false,
		},
		{
			name:           "Should not be equal as state is different",
			givenOldStatus: createEventingAuthStatus(metav1.ConditionTrue, metav1.ConditionTrue, "mock-app1", "mock-secret-ns1", StateReady),
			givenNewStatus: createEventingAuthStatus(metav1.ConditionTrue, metav1.ConditionTrue, "mock-app1", "mock-secret-ns1", StateNotReady),
			result:         false,
		},
	}
...
func createEventingAuthStatus(appReadyStatus, secretReadyStatus metav1.ConditionStatus, appName, secretNSName string, state State) EventingAuthStatus {
